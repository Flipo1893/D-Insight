...
import { hasAdmins, isAdmin } from "@/lib/stats/config";
...
export default async function Statistik() {
  ...
  if (!hasAdmins) {
    // Unreachable in practice, since isAdmin already failed. Kept as a
    // reminder that the allowlist is what gates this page.
    notFound();
  }
